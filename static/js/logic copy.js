...
function updateData() {
    ...
    let dataYear = fitleredData.map(elt => elt.CREATION_YEAR);

    console.log(`"Year Selected: ${dataYear}"`);

    buildGeoMap(filteredData);
    buildBarChart(dataYear, filteredData);
    buildLineChart(dataYear, filteredData);
